...
class TagDetection(object):
    """
    Defines a tag detection in an image
    
    Attributes:
        id (str): tag id
        hamming: hamming distance
        goodness: confidence value
        margin: confidence value
        homography: 3x3 homography matrix
        center: 1x2 (cx, cy) center of tag
        corners: 4x2 four corners of tag
        colors: 4x3 an RGB color for each corner
    """
...
class TagSubGraph(object):
    """A struct to hold tag graphs and other information about them"""

    def __init__(self):
        self.graph = None
        self.num_tags_in_images = None
        self.num_imgs = 0
        self.num_tags = 0
