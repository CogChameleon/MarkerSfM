...
BOOST_PYTHON_MODULE(csfm) {
  ...
  class_<BundleAdjuster, boost::noncopyable>("BundleAdjuster")
    ...
    .def("add_tag_observation", &BundleAdjuster::AddTagObservation)
    .def("add_const_tag_observation", &BundleAdjuster::AddConstTagObservation)
    .def("add_tag", &BundleAdjuster::AddTag)
    ...
    .def("set_tag_loss_function", &BundleAdjuster::SetTagLossFunction)
    .def("set_reprojection_error_sd", &BundleAdjuster::SetReprojectionErrorSD)
    .def("set_tag_size_sd", &BundleAdjuster::SetTagSizeSD)
    .def("set_tag_ortho_sd", &BundleAdjuster::SetTagOrthoSD)
    .def("set_tag_reproj_sd", &BundleAdjuster::SetTagReprojectionErrorSD)
    ...
    .def("set_use_tag_size_constraint", &BundleAdjuster::SetUseTagSizeConstraint)
    .def("set_use_tag_ortho_constraint", &BundleAdjuster::SetUseTagOrthoConstraint)
    .def("set_use_tag_reproj_constraint", &BundleAdjuster::SetUseTagReprojConstraint)
