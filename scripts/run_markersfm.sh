...
RunAndLog $1 $osfm_path/opensfm extract_metadata $1
RunAndLog $1 $osfm_path/opensfm detect_tags $1
RunAndLog $1 $osfm_path/opensfm detect_features $1
RunAndLog $1 $osfm_path/opensfm match_features $1
RunAndLog $1 $osfm_path/opensfm create_tracks $1
RunAndLog $1 $osfm_path/opensfm reconstruct $1
RunAndLog $1 $osfm_path/opensfm mesh $1
RunAndLog $1 $osfm_path/opensfm undistort $1
RunAndLog $1 $osfm_path/opensfm export_ply $1
RunAndLog $1 $osfm_path/export_nvm $1
